                        ...
                        @foreach($orders as $order)
                            <tr data-id="{{ $order->id }}">
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('member.order.detail', $order->id) }}" data-toggle="tooltip" class="btn btn-primary" data-placement="top" title="" data-original-title="Read">جزئیات</a>
                                    {{--<a href="#" onclick="confirmDelete('{{ route('order.destroy', $order->id) }}', '{{ $order->id }}')"  id="sa-warning" class="btn btn-outline-danger" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="fa fa-times"></i></a>--}}
