        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button id="payment-button1"
                            @if ($order->status)
                            @else
                            style="display:none;"
                            @endif

                            type="button"  class="btn btn-lg btn-success disabled btn-block">
                        <i class="fa fa-paypal fa-lg"></i>&nbsp;
                        <span id="payment-button-amount" >پرداخت شده</span>
                        <span id="payment-button-sending" style="display:none;">ارسال اطلاعات ...</span>
                    </button>

                    <button id="payment-button2"
                            @if ($order->status)
                            style="display:none;"
                            @else
                            @endif
                            type="button"  class="btn btn-lg btn-danger btn-block"
                            onclick="changState('{{ route('order.paying',$order->id) }}','{{csrf_token()}}')" >
                        <i class="fa fa-paypal fa-lg"></i>&nbsp;
                        <span id="payment-button-sending1" >پرداخت شود</span>
                        <span id="payment-button-sending2" style="display:none;">ارسال اطلاعات ...</span>
                    </button>
