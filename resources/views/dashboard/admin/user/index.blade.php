                    ...
                    <table id="bootstrap-data-table" class="table table-striped table-bordered">
                        ...
                        @foreach($users as $user)
                            <tr data-id="{{ $user->id }}">
                                ...
                                <td>
                                    <a href="{{ route('user.edit', $user->id ) }}" data-toggle="tooltip" class="btn btn-outline-primary" data-placement="top" title="" data-original-title="Edit"><i class="fa fa-edit"></i></a>
                                    <a href="#" onclick="confirmDelete('{{ route('user.destroy', $user->id) }}', '{{ $user->id }}')"  id="sa-warning" class="btn btn-outline-danger" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="fa fa-times"></i></a>
