                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100">
                        <div class="single-post post-style-1">
                            ...
                            <a class="avatar" href="{{ route('blog.getPostUser', $post->user->id) }}"><img src="{{ $post->user->image }}" alt="Profile Image"></a>

                            <div class="blog-info">

                                <h4 class="title"><a href="{{ route('blog.post', $post->id) }}"><b>{{ $post->abstract }}</b></a></h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100">
                        <div class="single-post post-style-1">
                            ...
                            <a class="avatar" href="#"><img src="/blog/images/averie-woodard-319832.jpg" alt="Profile Image"></a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100">
                        <div class="single-post post-style-1">
                            ...
                            <div class="blog-image"><img src="/blog/images/ben-o-sullivan-382817.jpg" alt="Blog Image"></div>
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="card h-100">
                        <div class="single-post post-style-2">
                            ...
                            <div class="blog-image"><img src="/blog/images/icons8-team-355990.jpg" alt="Blog Image"></div>
...
@if (collect(request()->segments())->get(1) == 'tags')

            <a class="load-more-btn" href="{{ route('blog.index') }}"><b>خانه </b></a>
            @endif
