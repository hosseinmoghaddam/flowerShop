...
//        dd(Tag::find(1)->products);
    ...
    public function shop(Request $request)
    {
        ...
        return view('site-en.shop', ['products'=>$products,'tags'=>$tags,'cat'=>$tag]);
    }

    public function blog(){
        return view('site-en.blog');
    }

    public function about(){
        return view('site-en.about');
    }

    public function contact(){
        return view('site-en.contact');
    }
    ...
    public function detail(Product $product)
    {
        ...
        return view('site-en.detail', ['product'=> $product, 'products'=> $products]);
    }
...
//        dd($products);
    ...
    public function care()
    {
        ...
        return view('site-en.care', compact('products'));
    }

    public function checkout()
    {
        $products = Session::get('products');
        return view('site-en.checkout', compact('products'));
    }
